...
public class AddEmployee extends JFrame{ //Third Frame
	...
	JTextField textField,textField_1,textField_2,textField_3,textField_4,textField_5,textField_6;
        ...
        public AddEmployee(){
            ...
            JLabel Address = new JLabel("Department");
            Address.setFont(new Font("Tahoma", Font.PLAIN, 17));
            Address.setBounds(60, 170, 150, 27);
            add(Address);
			
            String course[] = {"Receptionis","Housekeeping","Kitchen Staff","Room Service","Waiter/Waitress","Manager","Accountant","Chef"};
            ...
            ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("hotel/management/system/employee.jpg"));
